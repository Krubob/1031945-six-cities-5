...
const Offer = (props) => {
  const {offerId, offer, nearOffers, isOfferLoaded, isUserAuthorized, availableReviews, offerFavoriteStatus, changedFavoriteOffer, loadOfferAction, loadReviewsAction, loadNearOffersAction} = props;
